...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    /* │    CTRL   │     Z     │     X     │     C     │     V     │     B     │             │     N     │     M     │     ,     │     .     │     /     │   ]/ALT   │*/
       TD(ADV_CTRL),   KC_Z,       KC_X,       KC_C,       KC_V,       KC_B,                     KC_N,       KC_M,      KC_COMM,    KC_DOT,    KC_SLASH, ALT_T(KC_RBRC),
    /* └───────────┴───────────┴───────────┴───────────┴───────────┴───────────┘             └───────────┴───────────┴───────────┴───────────┴───────────┴───────────┘*/
    /*                                          ┌───────────┬───────────┬───────────┐   ┌───────────┬───────────┐                                                     */
    /*                                          │    LEFT   │ SPC/SHIFT │   SCUTS   │   │ ENT/RIGHT │   BKSPC   │                                                     */
                                                  MO(_LEFT),   SP_LSFT,     TD(MB),        ENT_RGT,    KC_BSPC,
    /*                                          └───────────┼───────────┼───────────┤   ├───────────┼───────────┘                                                     */
    /*                                                      │ MOUSE LEFT│MOUSE RIGHT│   │  MENU/WIN │                                                                 */
                                                               KC_BTN1,    KC_BTN2,     GUI_T(KC_APP)
    /*                                                      └───────────┴───────────┘   └───────────┘                                                                 */
    ),
...
#define ARROW_TRIGGER_H 100
#define ARROW_TRIGGER_V 400
#define ALT_TAB_LIMIT 500
...
void mb_finished(tap_dance_state_t *state, void *user_data) {
    mb_tap_state.state = cur_dance(state);
    switch (mb_tap_state.state) {
        case TD_SINGLE_TAP: 
...
void mb_reset(tap_dance_state_t *state, void *user_data) {
    switch (mb_tap_state.state) {
        ...
        case TD_DOUBLE_TAP: unregister_code16(KC_BTN1); break;
        case TD_DOUBLE_HOLD: 
            unregister_code16(KC_BTN1);
            break;
        default: break;
    }
    mb_tap_state.state = TD_NONE;
}

tap_dance_action_t tap_dance_actions[] = {
    [ADV_CTRL] = ACTION_TAP_DANCE_FN_ADVANCED(NULL, ctrl_finished, ctrl_reset),
    [MB] = ACTION_TAP_DANCE_FN_ADVANCED(NULL, mb_finished, mb_reset)
};  